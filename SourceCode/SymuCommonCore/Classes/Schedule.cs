...
namespace Symu.Common.Core.Classes
{
    /// <summary>
    ...
    public class Schedule
    {
            ...
            get
            {
                switch (Type)
                {
                    case TimeStepType.Weekly:
                        return (byte) System.Math.Floor(Step / 52.0F);
                    case TimeStepType.Monthly:
                        return (byte) System.Math.Floor(Step / 12.0F);
                    case TimeStepType.Intraday:
                    case TimeStepType.Daily:
                        return (byte) System.Math.Floor((float) Step / ConstYear);
        ...
        {
            return new DateTime(new TimeSpan(Convert.ToInt32(System.Math.Floor(days)), 0, 0, 0).Ticks);
        }
